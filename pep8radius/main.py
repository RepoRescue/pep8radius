...
DEFAULT_IGNORE = 'E24,E226,W50,W690'
...
def create_parser():
    ...
    ap.add_argument('--indent-size', default=DEFAULT_INDENT_SIZE,
                    ...
                    '(default %(default)s)')
    ap.add_argument('--hang-closing', action='store_true',
                    help='hang closing bracket instead of matching '
                    'indentation of opening bracket\'s line')
    ap.add_argument('-j', '--jobs', type=int, metavar='n', default=1,
...
def parse_args(arguments=None, root=None, apply_config=False):
    ...
    if args.ignore:
        ...
        # Match autopep8 behavior: always include W503 and W504 (mutually exclusive line break rules)
        args.ignore.update(['W503', 'W504'])
